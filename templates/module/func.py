    ...
    try:
        message = [  # 串列
            ImageSendMessage(  # 傳送圖片
                original_content_url="https://scontent.ftpe8-3.fna.fbcdn.net/v/t1.18169-9/24796662_1616376055052509_395931166705992775_n.jpg?_nc_cat=111&ccb=1-3&_nc_sid=8bfeb9&_nc_ohc=opeVk1mdkOYAX8WObr0&_nc_ht=scontent.ftpe8-3.fna&oh=ba95d9684c91f4d1b64bf0eb48287a79&oe=60AF6238",
                preview_image_url="https://scontent.ftpe8-3.fna.fbcdn.net/v/t1.18169-9/24796662_1616376055052509_395931166705992775_n.jpg?_nc_cat=111&ccb=1-3&_nc_sid=8bfeb9&_nc_ohc=opeVk1mdkOYAX8WObr0&_nc_ht=scontent.ftpe8-3.fna&oh=ba95d9684c91f4d1b64bf0eb48287a79&oe=60AF6238"
            ),
            TextSendMessage(  # 傳送y文字
...
def sendImage(event):  # 傳送圖片
    try:
        message = ImageSendMessage(
            original_content_url="https://scontent.ftpe7-4.fna.fbcdn.net/v/t1.18169-9/13428637_1117685771588209_3605427445168244962_n.jpg?_nc_cat=101&ccb=1-3&_nc_sid=730e14&_nc_ohc=QRADm8H5nn0AX8h_Ja9&_nc_ht=scontent.ftpe7-4.fna&oh=3eb8d295a3f6a2e182b9bfd325b7d5b7&oe=60B0A082",
            preview_image_url="https://scontent.ftpe7-4.fna.fbcdn.net/v/t1.18169-9/13428637_1117685771588209_3605427445168244962_n.jpg?_nc_cat=101&ccb=1-3&_nc_sid=730e14&_nc_ohc=QRADm8H5nn0AX8h_Ja9&_nc_ht=scontent.ftpe7-4.fna&oh=3eb8d295a3f6a2e182b9bfd325b7d5b7&oe=60B0A082"
        )
        line_bot_api.reply_message(event.reply_token, message)
    except:
        line_bot_api.reply_message(
...
#昂哥貼圖
def sendStick(event):  # 多項傳送
    try:
        message =   StickerSendMessage(  #傳送貼圖
                package_id='1',
                sticker_id='5'
            )
